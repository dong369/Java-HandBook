...
1、Editor › Suggest: Snippets Prevent Quick Suggestions勾掉即可。（解决双引号中代码不提示）
...
***步骤二：配置npm的全局模块***
配置npm的全局模块的存放路径以及cache的路径，我选择的路径使Node.js的安装路径，在此路径下建两个文件夹node_global和 node_cache，现在的文件目录如下![配置文件目录](http://upload-images.jianshu.io/upload_images/8185387-161e1cb09ddd16d6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
