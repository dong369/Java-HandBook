...
$>useradd -p tidbgroup # 创建用户组

$>useradd -p tidbgroup tidbuser # 创建指定用户组的用户
...
按如下进行配置：$>vim topology.yaml
  ...
  # #  Global variables are applied to all deployments and used as the default value  of  # # the  deployments if a specific deployment value is missing.  global:   user: "tidbuser"   ssh_port: 22   deploy_dir:  "/data/soft/tidb-deploy"   data_dir: "/data/soft/tidb-data"  # 离线备份考虑     server_configs:   pd:    replication.enable-placement-rules: true  # PD集群  pd_servers:   - host: 172.16.6.1   - host: 172.16.6.2   - host: 172.16.6.6     # TTIDB集群  tidb_servers:   - host: 172.16.6.1   - host: 172.16.6.2     # TTIKV集群  tikv_servers:   - host: 172.16.6.3   - host: 172.16.6.4   - host: 172.16.6.5     # 监控部分  monitoring_servers:   - host: 172.16.6.6  grafana_servers:   - host: 172.16.6.6  alertmanager_servers:   - host: 172.16.6.6     # 后期扩展部分     
