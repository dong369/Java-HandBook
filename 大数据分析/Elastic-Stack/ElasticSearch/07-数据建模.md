...
![](D:\dev\2019dev\code\idea-workspace\Java-HandBook\插图\服务中间件\Elastic-Stack\Mapping设置.png)

enbaled=>true false=>仅存储，不做搜索或聚合分析，默认false。

index=>true false=>是否构建倒排索引，默认false。
