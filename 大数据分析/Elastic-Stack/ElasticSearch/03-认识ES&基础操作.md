...
语法：put /prod_search_info/_doc/1   {"name":"guo","age":22}

```json
# create document
PUT /prod_search_info/_doc/1
{
  "username": "alfred",
  "age": 1
}
...
语法：POST /prod_search_info/_doc   {"name":"guo","age":22}

```json
# create document without id
POST /prod_search_info/_doc
{
  "username": "tom",
  "age": 20
}
...
语法：GET /prod_search_info/_doc/1

```json
# 指定id查询
GET /prod_search_info/_doc/1
...
# 批量操作 bulk api
POST _bulk
{"index":{"_index":"prod_search_info","_id":"1"}}
{"name":"alfred","age":20}
{"delete":{"_index":"prod_search_info","_id":"2"}}
{"update":{"_id":"3","_index":"prod_search_info"}}
{"doc":{"age":"20"}}
{"create":{"_index":"prod_search_info","_id":"4"}}
{"name":"guo","age":24}
```
...
```properties
# 根据id删除
DELETE /prod_search_info/_doc/1
